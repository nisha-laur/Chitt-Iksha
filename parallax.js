...
// the header ends here and the parallax begans from here
...
// appaerance of the site name after scene one 
if(scene3.active){
    document.querySelector(".btn").style.border= "1px solid #0000";
}else{
    document.querySelector(".btn").style.border= "1px solid #171716";
}
